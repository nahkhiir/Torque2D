...
#ifndef _SPRITE_GRID_CONTROLLER_H_
#define _SPRITE_GRID_CONTROLLER_H_
...
class SpriteGridController : public SpriteBase
{
protected:
...
public:
    ...
    DECLARE_CONOBJECT(SpriteGridController);
...
#endif //_SPRITE_GRID_CONTROLLER_H_
